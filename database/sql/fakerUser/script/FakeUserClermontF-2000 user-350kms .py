...
# Output file name
output_file="../resultSQL/fake_profiles-2000users-clermontF-350kms.sql"
...
base_lat = 45.7935  # Latitude of Clermont-Ferrand
base_lon = 3.0795   # Longitude of Clermont-Ferrand
radius_km = 350        # Radius in kilometers

numberUserGenerated = 2000
